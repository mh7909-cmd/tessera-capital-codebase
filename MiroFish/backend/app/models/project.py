...
Responsible for persistent project state on the server to avoid passing large data between interfaces.
"""
...
class ProjectStatus(str, Enum):
    """Project Status"""
    CREATED = "created"              # Created, file uploaded
...
class Project:
    ...
    # Ontology information (populated after Step 1)
    ontology: Optional[Dict[str, Any]] = None
    analysis_summary: Optional[str] = None
    
    # Graph information (populated after Step 2)
...
class ProjectManager:
    ...
    def _get_project_text_path(cls, project_id: str) -> str:
        """Get project extracted text path"""
    ...
    def list_projects(cls, limit: int = 50) -> List[Project]:
        ...
        Returns:
            Project list, descending by creation time
        """
        cls._ensure_projects_dir()
