        ...
        <div class="action-bar-header">
          ...
          <div class="action-bar-tabs">
            ...
            >
              ...
              <span>Chat with Intelligence Engine</span>
            </button>
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with any simulated agent' }}</span>
                <svg class="dropdown-arrow" :class="{ open: showAgentDropdown }" viewBox="0 0 24 24" width="12" height="12" fill="none" stroke="currentColor" stroke-width="2">
                  <polyline points="6 9 12 15 18 9"></polyline>
                </svg>
              </button>
              <div v-if="showAgentDropdown" class="dropdown-menu">
                <div class="dropdown-header">Select Target</div>
                <div 
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.profession || 'Researcher' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>Broadcast Survey to Swarm</span>
            </button>
          </div>
        </div>
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Direct interaction with the synthesis engine. Access memory-retrieval and cross-sectional analysis tools.</div>
              </div>
          ...
          <div class="survey-setup">
            <div class="setup-section">
              <div class="section-header">
                <span class="section-title">Select Participants</span>
              ...
              <div class="selection-actions">
                ...
                <button class="action-link" @click="clearAgentSelection">Clear All</button>
              </div>
            </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Ask a question to the selected group..."
                rows="3"
              ></textarea>
            </div>
