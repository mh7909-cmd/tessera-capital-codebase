      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Schema Generation</span>
          </div>
        ...
        <div class="card-content">
          ...
          <p class="description">
            Extraction of Reality Seeds, entity/relation relationships, and domain-specific knowledge schema based on seed intelligence.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">GraphRAG Orchestration</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Autonomous GraphRAG ingestion. Documents are processed via Zep to extract reality-anchored entities, relationships, and temporal memory kernels.
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        <div class="card-header">
          <div class="step-info">
            ...
            <span class="step-title">Initialization Ready</span>
          </div>
          <div class="step-status">
        ...
        <div class="card-content">
          ...
          <p class="description">Knowledge graph finalized. Reality mapping initialized and ready for simulation environment deployment.</p>
          <button 
            class="action-btn" 
          ...
          >
            ...
            {{ creatingSimulation ? 'Creating instance...' : 'Initialize Environment ➝' }}
          </button>
        </div>
      </div>
    </div>
...
// --- AUTO-PILOT Logic ---
// When graph is complete (phase 2), automatically advance
const hasAutoTriggered = ref(false)
watch(() => props.currentPhase, (newPhase) => {
  if (newPhase >= 2 && !hasAutoTriggered.value) {
    hasAutoTriggered.value = true
    console.log('🚀 MIROFISH AUTO-PILOT: Graph build complete. Auto-initializing environment...')
    setTimeout(() => {
      // If we are still on this page and not already creating, click it!
