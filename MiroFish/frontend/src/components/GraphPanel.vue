<template>
  <div class="graph-panel">
    <div class="panel-header">
      <span class="panel-title">ENTITY_RELATIONSHIP_MAP</span>
      <div class="header-tools">
        <button class="tool-btn" @click="$emit('refresh')" :disabled="loading" title="Refresh Map">
          <span class="icon-refresh" :class="{ 'spinning': loading }">↻</span>
          <span class="btn-text">REFRESH</span>
        </button>
        <button class="tool-btn" @click="$emit('toggle-maximize')" title="Toggle Maximize">
    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? 'Cognitive Telemetry Synchronizing' : 'Initializing Map Stream...' }}
        </div>
        ...
        <div v-if="showSimulationFinishedHint" class="graph-building-hint finished-hint">
          ...
          <span class="hint-text">Data processing in progress. Recommended refresh in T-30s.</span>
        ...
        <div v-if="selectedItem" class="detail-panel">
          <div class="detail-panel-header">
            <span class="detail-title">{{ selectedItem.type === 'node' ? 'NODE_SCHEMA' : 'RELATIONSHIP_VECTOR' }}</span>
          ...
          <div v-if="selectedItem.type === 'node'" class="detail-content">
            ...
            <div class="detail-section" v-if="selectedItem.data.summary">
              <div class="section-title">INTELLIGENCE_SUMMARY:</div>
          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                {{ selectedItem.data.source_name }} - Recursive Vectors
                ...
                >
                  ...
                  <div class="self-loop-item-content" v-show="expandedSelfLoops.has(loop.uuid || idx)">
                    ...
                    <div class="detail-row" v-if="loop.fact">
                      <span class="detail-label">ASSERTION:</span>
            ...
            <template v-else>
              ...
              <div class="detail-row">
                <span class="detail-label">VECTOR_TYPE:</span>
                <span class="detail-value">{{ selectedItem.data.fact_type || 'UNDEFINED' }}</span>
              </div>
      ...
      <div v-else-if="loading" class="graph-state">
        ...
        <p>ORCHESTRATING_GRAPH_RELATIONSHIPS...</p>
      </div>
      
      <!-- Offline/Idle -->
      <div v-else class="graph-state">
        <div class="empty-icon">❖</div>
        <p class="empty-text">AWAITING_SCHEMA_INTELLIGENCE...</p>
      </div>
    </div>

    <!-- Legend -->
    <div v-if="graphData && entityTypes.length" class="graph-legend">
      <span class="legend-title">ENTITY_TYPES</span>
    ...
    <div v-if="graphData" class="edge-labels-toggle">
      ...
      <span class="toggle-label">SHOW_EDGE_LABELS</span>
    </div>
  </div>
</template>
