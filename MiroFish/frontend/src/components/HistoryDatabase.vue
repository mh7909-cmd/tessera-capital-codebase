<template>
  ...
  >
    ...
    <div class="section-header">
      ...
      <span class="section-title">HISTORICAL REPLAY ARCHIVE</span>
      <div class="section-line"></div>
    </div>
      ...
      >
        ...
        <div class="card-files-wrapper">
          ...
          <div class="files-empty" v-else>
            ...
            <span class="empty-file-text">No documents identified</span>
          </div>
        </div>
    ...
    <div v-if="loading" class="loading-state">
      ...
      <span class="loading-text">INGESTING ARCHIVES...</span>
    </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-section">
                ...
                <div class="modal-requirement">{{ selectedProject.simulation_requirement || 'N/A' }}</div>
              </div>

              <!-- 文件列表 -->
              <div class="modal-section">
                <div class="modal-label">Linked Resources</div>
                ...
                <div class="modal-empty" v-else>No documents linked</div>
              </div>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">Audit Report</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
            <div class="modal-playback-hint">
              <span class="hint-text">Step 3 (Live Simulation) and Step 5 (Deep Interaction) require an active session and are not supported in historical replay.</span>
            </div>
          </div>
        </div>
      </Transition>
...
const truncateFilename = (filename, maxLength) => {
  if (!filename) return 'Unknown Resource'
