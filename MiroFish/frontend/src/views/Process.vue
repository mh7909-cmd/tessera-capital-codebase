<template>
  <div class="process-page">
    <!-- Top Navigation -->
    <nav class="navbar">
      <div class="nav-brand" @click="goHome">FIREFLY AEROSPACE | MIROFISH | April 29, 2026</div>
      
      <!-- Center Progress -->
      <div class="nav-center">
        <div class="step-badge">PHASE 01</div>
        <div class="step-name">Knowledge Graph Construction</div>
      </div>
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-if="graphData" class="graph-view">
            ...
            <div v-if="currentPhase === 1" class="graph-building-hint">
              ...
              Constructing Live Intelligence...
            </div>
          ...
          <div v-else-if="graphLoading" class="graph-loading">
            ...
            <p class="loading-text">Synchronizing Graph Data...</p>
          </div>
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-text">Awaiting Ontology Generation</p>
            <p class="waiting-hint">Graph construction will initiate automatically once the schema is defined.</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-text">Populating Graph Nodes</p>
            <p class="waiting-hint">Visualizing extracted entities...</p>
          </div>
        ...
        <div class="process-content">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  LLM analyzes document contents to auto-generate a knowledge schema (Entity Types + Relation Types) tailored for the simulation.
                </div>
              </div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Detected Entity Types ({{ projectData.ontology.entity_types?.length || 0 }})</div>
              ...
              <div class="detail-section" v-if="projectData?.ontology">
                <div class="detail-label">Relationship Schema ({{ projectData.ontology.relation_types?.length || 0 }})</div>
              ...
              <div class="detail-section waiting-state" v-if="!projectData?.ontology && currentPhase === 0 && !ontologyProgress">
                <div class="waiting-hint">Awaiting Ontology...</div>
              </div>
            </div>
          </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            <div class="phase-header">
              ...
              <div class="phase-info">
                <div class="phase-title">Intelligence Injection</div>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">Description</div>
                <div class="detail-content">
                  Chunking documents and utilizing Zep GraphRAG to populate the knowledge graph with high-fidelity entities and facts.
                </div>
              </div>
              
              <!-- Waiting -->
              <div class="detail-section waiting-state" v-if="currentPhase < 1">
                <div class="waiting-hint">Waiting for Phase 01...</div>
              </div>
              ...
              <div class="detail-section" v-if="graphData">
                <div class="detail-label">Build Metrics</div>
                <div class="build-result">
                  ...
                  <div class="result-item">
                    ...
                    <span class="result-label">Types</span>
                  </div>
                </div>
              </div>
            </div>
...
const statusText = computed(() => {
  ...
  if (currentPhase.value >= 2) return 'PHASE COMPLETE'
  if (currentPhase.value === 1) return 'BUILDING GRAPH...'
  if (currentPhase.value === 0) return 'GEN ONTOLOGY...'
  return 'INITIALIZING...'
})
...
const startGraphPolling = () => {
  ...
  // 每 3 秒自动获取一次图谱数据 (FAST REFRESH FOR DEMO)
    ...
    if (response.success) {
      ...
      if (task.status === 'completed') {
        ...
        if (projectResponse.success) {
          ...
          // --- AUTO-PILOT: Find Simulation and jump to Step 2 ---
          console.log('🚀 MIROFISH AUTO-PILOT: Polling for created simulation...')
          
          let checkCount = 0
          const checkSim = async () => {
            const simListRes = await listSimulations(currentProjectId.value)
            if (simListRes.success && simListRes.data?.length > 0) {
              const simId = simListRes.data[0].simulation_id
              console.log('⚡ Simulation detected:', simId, '- Redirecting...')
          ...
          // Initial check
          if (!(await checkSim())) {
            // Keep checking every 2 seconds for a bit
            const simPollTimer = setInterval(async () => {
              checkCount++
              const found = await checkSim()
              if (found || checkCount > 30) { // Max 1 min
