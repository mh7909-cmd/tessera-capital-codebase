...
def qualitative_growth_analyst_agent(state: AgentState, agent_id: str = "qualitative_growth_analyst"):
    """
    Analyzes stocks using qualitative growth principles:
      ...
      - Combine fundamental qualitative checks with basic sentiment and insider data
    ...
    for ticker in tickers:
        ...
        # Include relevant line items for this approach:
        ...
        growth_quality = analyze_qualitative_growth_quality(financial_line_items)
        ...
        qualitative_valuation = analyze_qualitative_valuation(financial_line_items, market_cap)
        ...
        total_score = (
            ...
            + qualitative_valuation["score"] * 0.15
        ...
        analysis_data[ticker] = {
            ...
            "valuation_analysis": qualitative_valuation,
            "insider_activity": insider_activity,
            "sentiment_analysis": sentiment_analysis,
            "research_context": state["data"].get("research_context", "No external documents provided."),
        }

        progress.update_status(agent_id, ticker, "Generating qualitative growth analysis")
        growth_output = generate_qualitative_growth_output(
            ticker=ticker,
    ...
    if state["metadata"].get("show_reasoning"):
        show_agent_reasoning(growth_analysis_payload, "Qualitative Growth Analyst")
...
def analyze_qualitative_growth_quality(financial_line_items: list) -> dict:
    """
    ...
    if rnd_values and revenues and len(rnd_values) == len(revenues):
        ...
        # Generally, we admire companies that invest aggressively in R&D,
...
def analyze_qualitative_valuation(financial_line_items: list, market_cap: float | None) -> dict:
    """
    Willing to pay for quality and growth, but still checks:
      - P/E
      - P/FCF
...
def generate_qualitative_growth_output(
    ticker: str,
    ...
    """
    Generates a JSON signal based on qualitative growth principles.
    """
    template = ChatPromptTemplate.from_messages(
        [
            (
              ...
              1. Scuttlebutt: Deep primary research.
              2. Management: Integrity and capability.
              3. Innovation: Sustained R&D leads to growth.
              4. 15-Point Check: Rigorous qualitative vetting.
            ...
            (
              "human",
              """Based on the following analysis, create a qualitative growth investment signal.
    ...
    return call_llm(
        ...
        state=state,
        agent_name=agent_id,
        default_factory=lambda: default_cot("qualitative_growth_analyst"),
    )
