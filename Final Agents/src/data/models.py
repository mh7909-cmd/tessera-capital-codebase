...
class LineItem(BaseModel):
    ...
    def __getattr__(self, item):
        """Institutional Silence: Return None for missing dynamic fields instead of raising AttributeError."""
        try:
            return super().__getattribute__(item)
        except AttributeError:
            # Check if it's in the extra fields first (though Pydantic usually handles this)
